...
var IronMImg,CAImg,ThorImg,SpiderMImg,HulkImg,AntMImg,HawkeyeImg;
var BackgroundImg;
...
function preload(){
BackgroundImg=loadImage("Images/AB.png")
...
AntMImg=loadImage("Images/Antman.png")
CAImg=loadImage("Images/CA.png")
HawkeyeImg=loadImage("Images/Hawkeye.png")
HulkImg=loadImage("Images/Hulk.png")
IronMImg=loadImage("Images/IronMan.png")
ThorImg=loadImage("Images/Thor.png")
SpiderMImg=loadImage("Images/Spidey.png")
}
...
function draw() {
  ...
  textSize(50)
  fill(255, 144, 0)
 text("WHICH AVENGER ARE YOU ? GAME",100,50)
if(gameState===START){
  fill(244, 71, 2)
 textSize(25)
 ...
 text("YOUR ANSWER WHICH AVENGER ARE YOU.",60,390)
...
if(gameState===END){
  ...
  if(Score>162 && Score<201){
    Result5.visible=true;
  }
  if(Score>202 && Score<241){
    Result6.visible=true;
  }
  if(Score>242 && Score<282){
